...
class ManageLeadController extends Controller
{
    ...
    public function list(Request $request) {
        ...
        try {            
            ...
            $query = Lead::query()->with(['user', 'taskStatus']);
    ...
    public function view(Request $request) {
        ...
        try {
            $task = Lead::where('id', '=', $request->task_id)->with(['user', 'taskStatus'])->first();
            if (!empty($task)) {
                return response()->json([
                    'status'    => 'success',
    ...
    public function update(Request $request) {
        ...
        try {
            $task = Lead::where('id', '=', $request->task_id)->first();
            if (empty($task)) {
                return response()->json([
                    'status'    => 'failed',
            ...
            $update = Lead::where('id', '=', $request->task_id)->update([
    ...
    public function changeStatus(Request $request) {
        ...
        try {
            ...
            $update = Lead::where('id', '=', $request->task_id)->update(['status' => $request->status]);
    ...
    public function delete(Request $request) {
        ...
        try {
            ...
            $delete = Lead::where('id', '=', $request->task_id)->delete();
