...
class ManageContactController extends Controller
{
    public function list(Request $request) {
        ...
        try {            
            ...
            $query = Contact::query()->with(['user', 'taskStatus']);
    ...
    public function view(Request $request) {
        ...
        try {
            $task = Contact::where('id', '=', $request->task_id)->with(['user', 'taskStatus'])->first();
            if (!empty($task)) {
                return response()->json([
                    'status'    => 'success',
    ...
    public function update(Request $request) {
        ...
        try {
            $task = Contact::where('id', '=', $request->task_id)->first();
            if (empty($task)) {
                return response()->json([
                    'status'    => 'failed',
            ...
            $update = Contact::where('id', '=', $request->task_id)->update([
    ...
    public function changeStatus(Request $request) {
        ...
        try {
            ...
            $update = Contact::where('id', '=', $request->task_id)->update(['status' => $request->status]);
    ...
    public function delete(Request $request) {
        ...
        try {
            ...
            $delete = Contact::where('id', '=', $request->task_id)->delete();
