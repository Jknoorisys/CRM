...
use App\Http\Controllers\Api\ManageInquiryController;
...
Route::middleware('set.locale')->group(function () {
    ...
    Route::middleware('jwt.verify')->group(function () {
        ...
        Route::get('master/categoryStage', [MastersController::class, 'categoryStage']);
        ...
        Route::post('dashboard/scrollable-leads', [DashboardController::class, 'scrollable_leads']);
        ...
        // Dashboard APIs
        Route::post('inquiry/list', [ManageInquiryController::class, 'list']);
        Route::post('inquiry/view', [ManageInquiryController::class, 'view']);
        Route::post('inquiry/addLead', [ManageInquiryController::class, 'addLead']);
    });
    // Dashboard APIs
    Route::post('inquiry/add', [ManageInquiryController::class, 'add']);
});
